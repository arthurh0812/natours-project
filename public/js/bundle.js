...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"pages.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.errorPage = exports.insertButton = exports.infoPage = void 0;

var infoPage = function infoPage(title, message) {
  // clear content
  var main = document.querySelector('.main');
  main.removeChild(main.childNodes[0]);
  var markup = "<div class=\"info\">\n                    <div class=\"info__title\">\n                      <h2 class=\"heading-secondary\">".concat(title, "</h2>\n                    </div>\n                    <div class=\"info__message\">").concat(message, "</div>\n                  </div>");
  main.insertAdjacentHTML('afterbegin', markup);
};

exports.infoPage = infoPage;

var insertButton = function insertButton(element, className, text) {
  var markup = "<button class=\"".concat(className, "\">").concat(text, "</div>");
  document.querySelector(".".concat(element)).insertAdjacentHTML('beforeend', markup);
};

exports.insertButton = insertButton;

var errorPage = function errorPage(message) {
  // clear content
  var main = document.querySelector('.main');
  main.removeChild(main.childNodes[0]);
  var markup = "<div class=\"error\">\n                    <div class=\"error__title\">\n                      <h2 class=\"heading-secondary.heading-secondary--error\">Huh?! Something went wrong!</h2>\n                    <div class=\"error__msg\">".concat(message, "</div>\n                  </div>");
  main.insertAdjacentHTML('afterbegin', markup);
};
...
exports.resendEmail = exports.signup = void 0;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _pages.infoPage)('Email Confirmation', 'We sent an email to check if you really have access to the email you typed in. Please check your email inbox!');
              (0, _pages.insertButton)('info', 'email-resend', 'Send email again');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Email successfully sent!');
            }
...
},{"axios":"../../node_modules/axios/index.js","./pages":"pages.js","./alerts":"alerts.js"}],"confirmEmail.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/users/confirmEmail/".concat(token)
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (emailOrUsername.includes('@')) data.email = emailOrUsername;else data.username = emailOrUsername;
            _context.prev = 2;
            _context.next = 5;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signed In succesfully!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Error signing out. Please check your internet connection!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _pages.infoPage)('Password Reset', 'We sent you an email to reset your password. Please check your email inbox!');
            }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, token) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              document.querySelector('.btn--reset-password').textContent = 'Change my Password';
              (0, _alerts.showAlert)('success', 'Successfully changed password');
              window.location.assign('/');
            });
...
},{"axios":"../../node_modules/axios/index.js","./pages":"pages.js","./alerts":"alerts.js"}],"updateUser.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(type === 'password' ? 'changeMyPassword' : 'updateMe'),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Saved ".concat(type, " succesfully!"));
            }
...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJ0aHVyMDgxMiIsImEiOiJja2Vremw4MW8xOWs3MnlucDBsMjU3dnF0In0.2mFIrbCnvElmVgjHWEM6tg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/arthur0812/ckel8lvxb12yd19nsfelafzbe',
    scrollZoom: false // center: startLocation.coordinates,
    // zoom: 4.4,
    // interactive: false,
  ...
  locations.forEach(function (loc, index) {
    ...
    if (index === 0) el.classList.add('start-marker');else el.classList.add('marker'); // integrate marker into mapbox map 'map'

    var marker = new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates) // add a popup to the marker
    .setPopup(new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"))).addTo(map); // marker should be popped up

    marker.togglePopup(); // extend map bounds to include current location
...
/* eslint-disable */
var paymentIntent = function paymentIntent(tourId) {
  // A reference to Stripe.js initialized with with real test publishable API key
  var stripe = Stripe('pk_test_51HSTXfKuxt2HJ9IyDhX3vaYE25zgguDdppRG1FCUwdnz8QlebPYcbskHEU5WlbSrFNkaTbmLkq5MNasLHJmWhYtP00OWxKF7oa');
  var paymentForm = document.querySelector('.payment-form');
  var paymentButton = document.querySelector('.btn--payment-form'); // disable the button until stripe is set up on the page
  ...
  (0, _axios.default)({
    ...
    paymentForm.addEventListener('submit', function (event) {
      event.preventDefault(); // complete payment when form is submitted
...
var paymentForm = document.querySelector('.payment-form'); // Delegation
...
if (loginForm) {
  loginForm.addEventListener('submit', function (event) {
    ...
    (0, _login.login)(emailOrUsername, password);
  });
  document.querySelector('.link--forgot-password').addEventListener('click', function (event) {
    event.preventDefault();
    var email = prompt('Please type in your email');
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (event) {
    document.querySelector('.btn--reset-password').textContent = 'Changing Password...';
    event.preventDefault();
    var newPassword = document.getElementById('password').value;
    var newPasswordConfirm = document.getElementById('passwordConfirm').value;
    var token = window.location.toString().split('/').slice(-1);
    (0, _forgotPassword.resetPassword)({
...
if (signupForm) {
  signupForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      var name, username, email, password, passwordConfirm, emailResendButton;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 9:
              emailResendButton = document.querySelector('.email-resend');
              emailResendButton.addEventListener('click', function (event) {
                if (event.which === 1) {
                  (0, _signup.resendEmail)();
                }
              });
...
if (emailConfirmationBox) {
  (0, _confirmEmail.confirmEmail)(emailConfirmationBox.dataset.token);
}
